...

{
  programs.plasma.shortcuts = {
    ...
    "kwin"."Window Close" = "Meta+Backspace,Alt+F4,Close Window";
    ...
    "kwin"."Window Minimize" = "Meta+M,Meta+PgDown,Minimize Window";
    "kwin"."Window Move" = "none,,Move Window";
    "kwin"."Window Move Center" = "none,,Move Window to the Center";
    "kwin"."Window No Border" = "none,,Toggle Window Titlebar and Frame";
    "kwin"."Window On All Desktops" = "none,,Keep Window on All Desktops";
    "kwin"."Window One Desktop Down" = "Meta+Ctrl+Shift+J,Meta+Ctrl+Shift+Down,Window One Desktop Down";
    "kwin"."Window One Desktop Up" = "Meta+Ctrl+Shift+K,Meta+Ctrl+Shift+Up,Window One Desktop Up";
    ...
    "kwin"."Window Quick Tile Bottom" = "Meta+Shift+J,Meta+Down,Quick Tile Window to the Bottom";
    "kwin"."Window Quick Tile Bottom Left" = "none,,Quick Tile Window to the Bottom Left";
    "kwin"."Window Quick Tile Bottom Right" = "none,,Quick Tile Window to the Bottom Right";
    "kwin"."Window Quick Tile Left" = "Meta+Shift+H,Meta+Left,Quick Tile Window to the Left";
    "kwin"."Window Quick Tile Right" = "Meta+Shift+L,Meta+Right,Quick Tile Window to the Right";
    "kwin"."Window Quick Tile Top" = "Meta+Shift+K,Meta+Up,Quick Tile Window to the Top";
